...
random_data <- function(D, clients, legislators, client_space = NULL, legislator_space = NULL, mu = NULL, Sigma = NULL, tau = NULL, alpha_popularity = NULL, Beta_popularity = NULL, v = NULL, sigma_sq_L = NULL, sigma_sq_P = NULL){
